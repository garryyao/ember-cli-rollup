...
Exporter.prototype._buildModuleMap = function(inputPaths) {
  ...
  inputPaths.forEach(function(fd) {
    ...
    if (parsed[filePath]) {
      ...
      Object.keys(parsed[filePath]).forEach(
        function(moduleName) {
          !modules[moduleName] && (modules[moduleName] = {});
          Object.assign(modules[moduleName], parsed[filePath][moduleName]);
        });
    } else {
      ...
      traverseImports(sourceFile, function(node) {
        ...
        !parsed[filePath][moduleName] && (parsed[filePath][moduleName] = modules[moduleName]);
