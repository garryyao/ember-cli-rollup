...
Bundler.prototype.build = function() {
  ...
  var moduleDefs = Object.assign(
    {"__global__": {js: "", opts: {entry: "in/rollup-global-in.js", dest: "out/rollup-global.js", format: ((options.global && options.global.format) || "iife")}}},
    Object.keys(options.standalone || {}).reduce(function(out, k) {
      out[k] = {
        js: "",
        opts: Object.assign({moduleId: k, format: "amd"}, options.standalone[k], {entry: "in/"+k+".js", dest: "out/"+k+".js"})
      };
      return out;
    }, {})
  );
  ...
  Object.keys(moduleDefs).forEach(function(k) {
    ...
    builds.push(
      build(inputTree, {out: inputPaths[0]}).then(function() {
        return build(new Rollup(inputTree, { rollup: moduleOptions }))
      })
    );
